    ...
    <div className="nav-bar">
      <nav>
        <div className="flex-left">
          ...
          {isSearchBarActive ? <ul className="nav-ul">
            <li className="categories-island" onMouseOver={()=> setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} >
                Categories
        ...
        <div className="flex-right">
            <button className="search-btn" onClick={() => setIsSearchBarActive((state) => !state)}>
